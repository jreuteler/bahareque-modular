...
1. Zuerst: Mörtel reisst (sichtbare Warnung)
...
Konservative Schätzung basierend auf der Mörtelschubfestigkeit (τ ≈ 0,3 MPa für 1:4 Zement:Sand-Mörtel) über den Paneelquerschnitt:

- Schubfläche: ~85 mm × 1.000 mm = 85.000 mm²
- Konservative Schubtragfähigkeit: 85.000 × 0,3 = ~25 kN pro Paneel
- Mit Sicherheitsfaktor 3: **~8 kN Gebrauchslast pro Paneel**

**Mit Diagonalverstrebung (die ausgelegte Konfiguration):**

Der diagonale Bambusstreifen (60 × 20 mm, Guadua angustifolia) auf Zug:

- Querschnitt: 1.200 mm²
- Konservative Zugfestigkeit: 80 MPa (bei ~50% der publizierten 150–200 MPa)
- Diagonale Zugtragfähigkeit: 1.200 × 80 = ~96 kN
- Horizontalkomponente (cos 69°): ~96 × 0,36 = ~34 kN pro Diagonale
- Zwei Diagonalen (eine pro Seite, eine auf Zug): ~34 kN
- Drahtbindungen und Mörtelverzahnung liefern zusätzlichen Widerstand
- Mit Sicherheitsfaktor 3: **~12–15 kN Gebrauchsschublast pro Paneel**

**Im Kontext:** Ein 3 m breiter Wandabschnitt (3 Paneele) liefert ~36–45 kN Schubwiderstand. Ein eingeschossiges Wohngebäude in einer moderaten Erdbebenzone (PGA 0,2g) mit 30 kN seismischer Masse über der Wand benötigt ungefähr 6 kN Fundamentschubwiderstand pro Laufmeter Wand. Drei Paneele pro Meter liefern das 4–5-Fache dieses Bedarfs.

Dies sind sehr konservative Zahlen. Die Mörtelmatrix, das Drahtbindungsgitter und das )( Profil tragen alle zusätzlichen Widerstand bei, der oben nicht berücksichtigt wurde.
...
| Geschätzte gleichmässige Drucktragfähigkeit | ~0,7 kPa |
| Mit Sicherheitsfaktor 2 | **~0,35 kPa Gebrauchslast** |

**Im Kontext:** 0,35 kPa ≈ Windgeschwindigkeit ~25 m/s (90 km/h). Für höhere Windzonen übernimmt der Stahlrahmen (nicht das Paneel) die Windlast über die Riegel-Stützen-Verbindungen. Das Paneel muss nur den lokalen Druck zwischen seinen eigenen Rahmenelementen aufnehmen.
...
## Dauerhaftigkeit (80–100 Jahre Auslegungslebensdauer)

| Komponente | Abbauprozess | Prävention | Erwartete Lebensdauer |
|-----------|-------------|-----------|----------------------|
| Stahlrahmen | Korrosion | Feuerverzinkung (85 μm+) | 80–100 Jahre (nicht küstennah) |
