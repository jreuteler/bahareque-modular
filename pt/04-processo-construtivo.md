...
6. **Ligar a vibração:** Operar a mesa por 30–60 segundos. A vibração:
   - Empurra a argamassa através dos espaços entre as tiras
   - Preenche completamente a cavidade central
   - Elimina vazios e bolsas de ar
   - A argamassa penetra até a tela da face frontal (agora apoiada sobre a areia)
7. **Nivelar** o excesso de argamassa rente às bordas da estrutura
8. **Alisar** com desempenadeira (isto se torna a face interna)
...
**Por que mesa vibratória sobre leito de areia?**
- Gravidade + vibração = preenchimento completo, sem vazios
- Leito de areia = sem necessidade de forma, a areia se acomoda ao formato do painel
- Sem necessidade de equipamento de pulverização (mais barato que argamassa pulverizada)
- Vertimento por um lado preenche ambos os lados — a argamassa flui pelos espaços entre as tiras
- Qualidade consistente — a vibração elimina erro humano
