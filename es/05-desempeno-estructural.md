...
Sin embargo, los paneles son **estructuralmente capaces de funcionar sin un marco de acero**. Con capacidad de compresión que excede ampliamente las cargas residenciales típicas (dos postes laterales de ángulo L L 40×40×4), una fila de paneles puede soportar cómodamente un segundo piso y techo sin una estructura de acero independiente. Una viga de coronación simple de madera o bambú en la parte superior conecta los paneles y distribuye la carga del techo.
...
> **Advertencia:** Los valores a continuación son estimaciones analíticas conservadoras basadas en propiedades de materiales y geometría. NO están basados en pruebas de laboratorio. No use estos valores para ingeniería estructural sin verificación independiente. El desempeño real depende de la calidad de los materiales, la mano de obra y los detalles de conexión. Ver [Pruebas Necesarias](#pruebas-necesarias) más adelante.

### Peso Propio del Panel

| Componente | Peso |
|------------|------|
| Marco de acero ángulo L (L 40×40×4, 7 m a 2,42 kg/m + tiras de sujeción + cartelas) | ~22 kg |
| Mortero del núcleo (base: cemento-arena, ~0,147 m³, densidad curada ~2 000 kg/m³) | ~294 kg |
| Tiras de bambú + diagonales (~30 % densidad de cavidad) | ~38 kg |
| Bloques de HDPE, alambre, malla, conducto, cables | ~6 kg |
| Pañete de cal (10 mm en ambas caras) | ~100 kg |
| **Peso total del panel, mezcla base** | **~460 kg** |
| **Peso por m² de muro, base** | **~184 kg/m²** |
| Peso total del panel, mezcla bahareque optimizada (cal puzolánica + pasto estrella + 5 mm de pañete) | ~380 kg |
| Peso por m² de muro, optimizado | ~152 kg/m² |
| Peso de envío del montaje en seco (marco + bambú + malla + instalaciones, antes del vertido del mortero) | ~75 kg |

Para comparación: muro de bloque de concreto de 150 mm ≈ 180 kg/m². El sistema de paneles (mezcla base) tiene aproximadamente el mismo peso que la mampostería convencional por unidad de área, y la mezcla bahareque optimizada es ~15 % más ligera. Crítico para la logística: el **peso de envío del montaje en seco (~75 kg)** es la forma en la que el panel se transporta del taller a la obra (el mortero se vierte in situ).

### Carga Axial (Vertical)

Cada panel tiene dos postes laterales verticales de ángulo L que pueden soportar cargas de compresión significativas:

| Elemento | Sección transversal | Capacidad axial conservadora |
|----------|---------------------|------------------------------|
| Poste lateral de ángulo L (L 40×40×4 mm) | A ≈ 304 mm² | ~36 kN por poste (a σ = 120 MPa, ~50 % de la fluencia A36) |
| Dos postes laterales por panel | 2 × 304 mm² | ~72 kN por panel (~7 200 kg) |

**Qué significa esto en la práctica:**

Una casa típica de un piso con altillo y techo de teja de barro impone aproximadamente 200–400 kg de carga por metro lineal de muro (techo + cielo raso + entrepiso del altillo + carga viva). Un solo panel de 1 m puede soportar **18–36× este requerimiento**. **Los paneles no necesitan un marco de acero separado para soportar un segundo piso y techo.**
...
El pandeo no es una preocupación a estos niveles de carga **cuando el ángulo L está embebido en el composite del panel**: el espesor del muro de mortero de 85 mm proporciona al marco de ángulo rigidez lateral continua, y la relación altura-espesor del panel (~2 500/85 ≈ 29) está bien dentro de los límites de esbeltez aceptados para muros reforzados.

**Importante: limitación del eje débil de perfiles abiertos.** Los perfiles estructurales abiertos — ángulos L, perfiles T, perfiles C — tienen rigidez mínima alrededor de su eje débil. Un poste L 40×40×4 independiente sin arriostramiento del panel (I_min ≈ 3,8 × 10⁴ mm⁴ alrededor del eje débil que pasa por el talón) pandearía bajo carga moderada. La capacidad de 36 kN por ángulo L indicada arriba es la **capacidad axial de fluencia** y SOLO es alcanzable cuando el ángulo está continuamente arriostrado por el relleno del panel (mortero + guadua). Esta distinción es crítica para la secuencia constructiva — el marco de ángulo L no debe cargarse axialmente antes de que los paneles sean vertidos, curados y carguen como composite. Para columnas independientes en edificios de varios pisos los perfiles abiertos no son apropiados — usar perfil hueco cuadrado (SHS) en su lugar.
...
Estimación conservadora basada en la resistencia al corte del mortero (τ ≈ 0,3 MPa para mortero 1:4 cemento:arena) a lo largo de la sección transversal del panel:

- Área de corte: ~85 mm × 1.000 mm = 85.000 mm²
- Capacidad conservadora de corte: 85.000 × 0,3 = ~25 kN por panel
...
| Elementos pesados (gabinetes de cocina, calentador de agua, soporte de TV) | Perno pasante al alma del ángulo L de acero | 50–100 kg por anclaje |
| Elementos muy pesados (biblioteca, alacena llena) | Múltiples pernos pasantes al ángulo L + placa de distribución | 200+ kg por punto de montaje |

**Consejo:** El alma del ángulo L está en una posición conocida (a lo largo de un costado del panel, en la profundidad del muro). Un detector de vigas o imán la localiza fácilmente. El empernado pasante al alma proporciona anclaje confiable y de alta capacidad comparable a la estructura de perfiles de acero.
...
| **Axial (vertical)** | Hacia abajo, a través del panel | **Excede ampliamente las cargas residenciales (~7 200 kg de fluencia axial por panel en composite)** | Los dos ángulos L laterales soportan mucho más que un techo típico + piso superior por metro de muro. Los paneles pueden soportar un segundo piso y techo sin marco de acero separado. |
...
| **Carga puntual en ángulo L** | Perno pasante | **~50–100 kg por perno** | Un gabinete de cocina con 4 pernos pasantes sostiene 200–400 kg de forma segura. |
...
|------------|-------------------------|------------|---------------|
| Marco de acero | Corrosión | Galvanizado en caliente (85 μm+) | 80–100 años (no costero) |
...
- [ ] **Pruebas de corte por volcamiento** (ASTM E564 o equivalente) — paneles con y sin diagonales, para validar la mejora estimada de 3–5×
...
- [ ] **Pruebas de extracción de carga puntual** — capacidad de anclaje de mampostería y perno pasante en mortero + ángulo L
