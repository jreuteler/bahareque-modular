...
### Paso 6: Voltear y Repetir (Lado 2)
...
6. **Iniciar vibración:** Hacer funcionar la mesa por 30–60 segundos. La vibración:
   - Empuja el mortero a través de los espacios entre las tiras
   - Llena la cavidad central completamente
   - Elimina vacíos y bolsas de aire
   - El mortero penetra hasta la malla de la cara frontal (que descansa sobre la arena)
7. **Enrasar** el exceso de mortero a ras con los bordes del marco
8. **Llana** lisa (esta se convierte en la cara interior)
...
**¿Por qué mesa vibradora sobre cama de arena?**
- Gravedad + vibración = llenado completo, sin vacíos
- Cama de arena = no se necesita molde, la arena se conforma a la forma del panel
- No se necesita equipo de rociado (más barato que mortero rociado)
- Vertido de un solo lado llena ambos lados — el mortero fluye a través de los espacios entre tiras
- Calidad consistente — la vibración elimina el error humano
