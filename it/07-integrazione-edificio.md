...
![Integrazione nell'Edificio](svg/08-building-integration.svg)
...
| Elemento | Specifica |
|----------|-----------|
| Pilastri | HEA 150 o equivalente (dimensionati secondo calcolo ingegneristico) |
| Travi | IPE 160–200 (campata tra pilastri) |
| Connessioni | Imbullonate in cantiere; piastre di connessione pre-saldate in laboratorio |
| Interasse pilastri | 2–4 m (incrementi di 1 m = numero esatto di pannelli per campata) |
| Fondazione | Calcestruzzo armato secondo il codice sismico locale |

### Relazione Pilastro-Pannello

Il dettaglio progettuale chiave: **i pilastri sono arretrati dello spessore del pannello** rispetto alle travi.
...
1. **Telaio in acciaio eretto** — pilastri, travi, struttura del tetto completi
...
5. **Continuare lungo l'edificio** — i pannelli riempiono ogni campata tra i pilastri
...
|← Intonaco di calce (3-5mm)
|← Malta (15mm)
|← Rete a maglia esagonale
|← Listelli di bambù
|← Anima profilo a T  ┌─────────┐
|← Riempimento malta    │ PILASTRO│  ← HEA 150
|← Listelli di bambù   │(nascosto)│   (arretrato)
|← Rete a maglia esag. │         │
|← Malta (15mm)         └─────────┘
|← Intonaco di calce
...
| Pareti curve | Non supportate (i pannelli sono piani). Usare approssimazione sfaccettata con pilastri angolati. |
