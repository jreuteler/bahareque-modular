...
|---------|--------|-------|
| *Dendrocalamus asper* | Southeast Asia | Large diameter, strong. Direct substitute. |
| *Bambusa bambos* | South/Southeast Asia | Thorny, strong. Requires wider strips. |
| *Phyllostachys edulis* (Moso) | China, temperate zones | Smaller diameter. Use wider, thinner strips. |
| *Phyllostachys bambusoides* | Japan, temperate zones | Good strength. Smaller culms. |
| *Guadua chacoensis* | Argentina, Paraguay | Close relative of G. angustifolia. |
